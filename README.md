...
* 有可能会出现平台哪吒不能运行的情况，可以自己更换系统，默认Debian，换成alpine会有所改变，实在无法部署！这也是实在没法避免的。项目已经最大程度的把相关的依赖库都已经弄好，以保证在各个平台正常运行。如果不能正常运行可能就是平台的启动方式，需要自己阅读相关的官方文档进行调试，无须改动环境启动器的脚本。
